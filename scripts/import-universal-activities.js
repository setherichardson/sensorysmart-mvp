...
// Import the universal activities
const universalActivities = require('../lib/universal-sensory-activities.json')

async function importUniversalActivities() {
  console.log('🚀 Starting import of universal sensory activities...')
